...
file_name3 = download_CMI(yyyymmddhhmn, band3, input)
...
#-----------------------------------------------------------------------------------------------------------
# Save the image
plt.savefig(f'{output}/glaciacao_1630.png', bbox_inches='tight', pad_inches=0.2, dpi=300)
