...
# Datetime to process
yyyymmddhhmn = '202210031620'
yyyymmddhhmn2 = '202210031630'
band = '15'
band2 = '15'

# Download the file
file_name = download_CMI(yyyymmddhhmn, band, input)
file_name2 = download_CMI(yyyymmddhhmn2, band2, input)
...
colormap = "seismic" # White to black for IR channels
...
vmax = 84.0                                                      # Max. value
vmin2 = -40.0                                                    # Min. value
vmax2 = 40.0                                                      # Max. value
    
# Plot the image
img3 = ax.imshow(datafinal, vmin=vmin2, vmax=vmax2, origin='upper', extent=img_extent, cmap=colormap)
...
# Extract date
date = (datetime.strptime(dtime2, '%Y-%m-%dT%H:%M:%S.%fZ'))
...
#-----------------------------------------------------------------------------------------------------------
# Save the image
plt.savefig(f'{output}/derivada_1630.png', bbox_inches='tight', pad_inches=0.2, dpi=300)
