...
end_time = '202211082030'    # 23Z do dia 25/10/2019
...
# Define the color scale based on the channel
    colormap = "Blues" # Blue, white and red
...
#    plt.title('Reg.: ' + str(extent) , fontsize=10, loc='right')
    ...
    plt.savefig(f'{output}/tamanhoparticula_zoom_{data_formatada}.png', bbox_inches='tight', pad_inches=0.2, dpi=300)
