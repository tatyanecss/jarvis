...
# Datetime to process
yyyymmddhhmn = '202210031520'
yyyymmddhhmn2 = '202210031530'
band = '15'
band2 = '15'
...
# Add a title
plt.title('Tamanho da partícula ' + date.strftime('%Y-%m-%d %H:%M') + ' UTC', fontweight='bold', fontsize=10, loc='left')
plt.title('Reg.: ' + str(extent) , fontsize=10, loc='right')
#-----------------------------------------------------------------------------------------------------------
# Save the image
plt.savefig(f'{output}/tamanhoparticula_1540.png', bbox_inches='tight', pad_inches=0.2, dpi=300)
